...
export function ProjectsSection() {
    ...
    return (
        <>
                                ...
                                <CarouselItem className="bg-white flex w-full">
                                    <div className="flex flex-col w-1/2 p-8 text-left">
                                        ...
                                        <p className="text-gray-700 mb-4">
                                            All electrical work has been
                                            completed at Viewbank, including:
                                        </p>
                                        <ul className="space-y-3">
                                            <li className="flex items-start">
                                                ...
                                                <span className="text-gray-700">
                                                    3x double power points
                                                    installed for the benchtops
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <span className="text-yellow mr-2">
                                            ...
                                            <li className="flex items-start">
                                                ...
                                                <span className="text-gray-700">
                                                    ...
                                                    batten light replaced with a
                                                    new LED light fitting
                                                    (supplied by owner)
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                ...
                                                <span className="text-gray-700">
                                                    Old batten holder replaced
                                                    with a small pendant light
                                                    (also supplied by owner)
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <span className="text-yellow mr-2">
                                                ...
                                                <span className="text-gray-700">
                                                    Existing oven circuit
                                                    updated to include a safety
                                                    switch
                                                </span>
                                            </li>
                                        </ul>
            ...
            <ImageModal
                images={["/assets/dark-bulb.jpg", "/assets/bulb-hero.jpg"]}
                isOpen={modalOpen}
