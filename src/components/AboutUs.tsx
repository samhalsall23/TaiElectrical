                ...
                <div className="flex items-center text-center p-6 bg-white rounded-lg shadow-lg">
                    <div className="flex flex-col items-center w-4/5 md:w-3/5">
                        ...
                        <p className="text-gray-600">
                            We are a team of experienced electricians dedicated
                            to providing top-notch electrical services for
                            residential and commercial properties. Our mission
                            is to ensure your electrical systems are safe,
